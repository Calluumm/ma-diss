...
def buildWorkflowDiagram() -> None:
    ...
    def box(bx, fill=PANEL_BG, edge=PANEL_BORDER):
        x1, y1, x2, y2, title, body = bx
        draw.rounded_rectangle((x1, y1, x2, y2), radius=18, fill=fill, outline=edge, width=3)
    ...
    arrow(580, 265, 660, 265)
    arrow(1110, 265, 1190, 265)
    arrow(1640, 265, 1720, 265)
    arrow(870, 360, 760, 540)
    arrow(1780, 360, 1580, 540)
    arrow(1000, 650, 1070, 650)
    arrow(1370, 760, 1150, 920)
